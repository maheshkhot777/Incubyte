...
Feature: Customer Sign Up & Sign IN Functionality
  ...
  Scenario Outline: Verify Successful Account Creation
    ...
    Examples: 
      ...
      | Mahesh     | autotestdata | autotestdata | autotestdata  |
      | autotestdata | Khot       | autotestdata | autotestdata  |
      | autotestdata | autotestdata | autotestdata | Mahesh@2311 |
  ...
  Scenario Outline: Verify Duplicate Email ID Account Creation
    ...
    Examples: 
      | FirstName | LastName | emailid           | password    |
      | Mahesh  | Khot   | bbb1233@gmail.com | Test1234567 |
  ...
  Scenario Outline: Verify Invalid email address for Account Creation
    ...
    Examples: 
      | FirstName | LastName     | emailid | password     |
      | Mahesh  | autotestdata |  123456 | autotestdata |
  ...
  Scenario Outline: Validate Password with length less than eight
    ...
    Examples: 
      | FirstName | LastName     | emailid      | password |
      | Mahesh  | autotestdata | autotestdata |      123 |
